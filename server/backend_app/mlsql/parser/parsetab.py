...
_lr_productions = [
  ...
  ('exp -> TRAIN WORD WITH WORD DELIMITER','exp',5,'p_train','parser.py',137),
  ('exp -> TRAIN WORD WITH TRAINING_PROFILE WORD DELIMITER','exp',6,'p_train','parser.py',138),
  ('exp -> PREDICT WITH SQL BY ESTIMATOR WORD DELIMITER','exp',7,'p_predict','parser.py',158),
  ('exp -> PREDICT WITH TRAINING_PROFILE WORD BY ESTIMATOR WORD DELIMITER','exp',8,'p_predict','parser.py',159),
  ('exp -> CLONE ESTIMATOR WORD AS WORD DELIMITER','exp',6,'p_clone_model','parser.py',185),
  ('exp -> CLONE ESTIMATOR WORD AS WORD WITH WEIGHTS DELIMITER','exp',8,'p_clone_model','parser.py',186),
  ('exp -> USE URL DELIMITER','exp',3,'p_use_database','parser.py',208),
  ('exp -> SQL DELIMITER','exp',2,'p_SQL','parser.py',226),
  ('exp -> SET DEBUG BOOL DELIMITER','exp',4,'p_DEBUG','parser.py',234),
]
