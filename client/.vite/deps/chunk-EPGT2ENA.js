...
var StyleContext = React9.createContext({
  hashPriority: "low",
  cache: createCache(),
  defaultCache: true
});
...
function useStyleRegister(info, styleFn) {
  ...
  return function(node2) {
    ...
    if (!ssrInline || isMergedClientSide || !defaultCache) {
      ...
      var _ref6;
      styleNode = React13.createElement("style", _extends({}, (_ref6 = {}, _defineProperty(_ref6, ATTR_TOKEN, cachedTokenKey), _defineProperty(_ref6, ATTR_MARK, cachedStyleId), _ref6), {
  ...
  var CSSMotionList = function(_React$Component) {
    ...
    _createClass(CSSMotionList2, [{
      ...
      value: function render() {
        ...
        return React27.createElement(Component4, restProps, keyEntities.map(function(_ref2, index2) {
...
var CollectionContext = React33.createContext(null);
function Collection(_ref) {
  var children = _ref.children, onBatchResize = _ref.onBatchResize;
  var resizeIdRef = React33.useRef(0);
  var resizeInfosRef = React33.useRef([]);
  var onCollectionResize = React33.useContext(CollectionContext);
  var onResize2 = React33.useCallback(function(size, element, data) {
  ...
  return React33.createElement(CollectionContext.Provider, {
    value: onResize2
  }, children);
}
...
function SingleObserver(props, ref) {
  ...
  var onCollectionResize = React35.useContext(CollectionContext);
  var isRenderProps = typeof children === "function";
  var mergedChildren = isRenderProps ? children(elementRef) : children;
  var sizeRef = React35.useRef({
    width: -1,
    height: -1,
    offsetWidth: -1,
    offsetHeight: -1
  });
  var canRef = !isRenderProps && React35.isValidElement(mergedChildren) && supportRef(mergedChildren);
  ...
  var propsRef = React35.useRef(props);
  propsRef.current = props;
  var onInternalResize = React35.useCallback(function(target) {
  ...
  return React35.createElement(DomWrapper2, {
    ref: wrapperRef
  }, canRef ? React35.cloneElement(mergedChildren, {
    ref: mergedRef
  }) : mergedChildren);
}
var RefSingleObserver = React35.forwardRef(SingleObserver);
if (true) {
...
function ResizeObserver2(props, ref) {
  ...
  return childNodes.map(function(child, index2) {
    ...
    return React36.createElement(SingleObserver_default, _extends({}, props, {
      key,
      ref: index2 === 0 ? ref : void 0
    }), child);
  });
}
var RefResizeObserver = React36.forwardRef(ResizeObserver2);
if (true) {
...
*/
//# sourceMappingURL=chunk-EPGT2ENA.js.map
